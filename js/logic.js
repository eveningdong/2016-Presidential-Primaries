var create_simplemaps_countymap = function(no_clone) {
    ...
    function set_attributes() {
        ...
        for (var id in mapinfo.paths) {
            ...
            //  console.log(default_state.color);
    ...
    function create_states(refresh) {
        ...
        function make_state(id) {
            ...
            //判断id是哪个county根据country的data设置颜色
    ...
    function create_event_handlers() {
        ...
        click = function() {
            d3.selectAll(".bargraphparty").remove();
            //    d3.selectAll(".partybar_label_text").remove(); 
            //  d3.selectAll(".partybar_label").remove(); 
            ...
            if (id.length == 2) {
                ...
                countyText.text(state_p);
            } else if (id.length == 5) {
                county_p = simplemaps_countymap_mapinfo.names[id];

                // Automatically jump to bottom
                d3.select('#map').on('click', function() {
                    document.getElementById('county').scrollIntoView(true);
                })
                ...
                function drawBarChart(state, county, type) {
                    ...
                    var stateName = state;
                    var state_data = county_data["states"][state];
                    var state_abbr = abbrState(stateName, 'abbr');

                    if (state_data != null && state_abbr != null){
                        ...
                        if (county_info != null) {
                            ...
                            for (var i = 0; i < categories.length; i++) {
                                ...
                                data.push({
                                    ...
                                    "ages": [{
                                        "name": county,
                                        "value": county_info[category]
                                    }, {
                                        "name": state,
                                        "value": state_data[category]
                                    }, {
                                        "name": "USA",
                                        "value": usa_average[category]
                                    }]
                                });
                            ...
                            var barchart = d3.select("#barchart").append("svg").attr("class", "barchart2")
                            ...
                            legend.append("text")
                                ...
                                console.log("Could not find data for the state");
                                var barchart = d3.select("#barchart");
                                barchart.innerHTML = "Sorry. No data available";
                            }
                    } else {
                         console.log("Could not find data for the county");
                         var barchart = d3.select("#barchart");
                         barchart.innerHTML = "Sorry. No data available";
                    }
                }
                ...
                $(document).ready(function(){  
                     window.updateMaps = function(){  
                        console.log("functionworld")
                ...
                var svg_p = d3.select("#partybar").append("svg").attr("height", height_p).attr("width", width_p).attr("class", "bargraphparty");
                ...
                if (results[state_p] == null){
                    ...
                    fractions = {
                    t: results[state_p][county_p]["Donald Trump"] == null?0:results[state_p][county_p]["Donald Trump"].Fraction,
                    c: results[state_p][county_p]["Ted Cruz"] == null?0:results[state_p][county_p]["Ted Cruz"].Fraction,
                    h: results[state_p][county_p]["Hillary Clinton"] == null?0:results[state_p][county_p]["Hillary Clinton"].Fraction,
                    s: results[state_p][county_p]["Bernie Sanders"] == null?0:results[state_p][county_p]["Bernie Sanders"].Fraction,
                ...
                var trumpBar = {
                    ...
                    height: bar_height,
                    votes: results[state_p] == null?0:results[state_p][county_p]["Donald Trump"].Votes
                }
                ...
                var cruzBar = {
                    ...
                    height: bar_height,
                    votes: results[state_p] == null?0:results[state_p][county_p]["Ted Cruz"].Votes
                }
                ...
                var clintonBar = {
                    ...
                    height: bar_height,
                    votes: results[state_p] == null?0:results[state_p][county_p]["Hillary Clinton"].Votes
                }
                ...
                var sandersBar = {
                    ...
                    height: bar_height,
                    votes: results[state_p] == null?0:results[state_p][county_p]["Bernie Sanders"].Votes
                }
                ...
                var dOtherBar = {
                    ...
                    height: bar_height,
                    votes: results[state_p] == null?"Data Not Available":Math.round(clintonBar.votes / fractions.h * fractions.d)
                }
                ...
                var rOtherBar = {
                    ...
                    height: bar_height,
                    votes: results[state_p] == null?"Data Not Available":Math.round(trumpBar.votes / fractions.t * fractions.r)
                }
                ...
                var rTip = d3.tip()
                    ...
                    .offset([-10, 0])
                    .html(function(d) {
                        return results[state_p] == null?"<strong style='color:white'>Data Not Available</strong>":"<strong style='color:white'>Other Republican:</strong> <span style='color:grey'>" + rOtherBar.votes + " votes" + "</span>" +
                ...
                var dTip = d3.tip()
                    ...
                    .offset([-10, 0])
                    .html(function(d) {
                        return results[state_p] == null?"<strong style='color:white'>Data Not Available</strong>":"<strong style='color:white'>Other Democrats:</strong><span style='color:grey'>" + dOtherBar.votes + " votes" + "</span>" +
                            "<strong style='color:white'> Total Democrats:</strong><span style='color:grey'>" + dTotalVotes + " votes" + "</span>";
                    });
                ...
                var dOther_bar = svg_p.append("rect")
                    ...
                    .on('mouseover', function(d) {
                        dTip.show(d);
                        portrait.attr("xlink:href", "images/Democratic-donkey.png");
                    })
                    .on('mouseout', function(d) {
                        dTip.hide(d);
                        portrait.attr("xlink:href", "");
                ...
                var rOther_Bar = svg_p.append("rect")
                    ...
                    .on('mouseover', function(d) {
                        rTip.show(d);
                        portrait.attr("xlink:href", "images/Republicanlogo.svg.png");
                    })
                    .on('mouseout', function(d) {
                        rTip.hide(d);
                        portrait.attr("");
